<template>
      ...
      <nav class="flex-1 px-4 space-y-2" role="navigation">
        ...
        >
          ...
          >
            ...
            <span
              v-if="!isExpanded"
              class="absolute left-full ml-4 px-2 py-1 text-sm font-medium text-white bg-gray-900 rounded-md opacity-0
  ...
  group-hover:opacity-100"
        ...
        <button
          @click="handleLogout"
          class="relative flex w-full items-center p-3 rounded-full transition-all duration-200 group text-gray-600 hover:bg-red-100
  hover:text-red-700"
